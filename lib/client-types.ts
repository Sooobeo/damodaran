...
export type Translation = { id: string; textKo: string; validationStatus: string; reviewStatus: string; current: boolean; structure?: Record<string, unknown> | null; warnings?: string[]; reviewId?: string | null; origin?: 'user' | 'memory' | 'machine'; quality?: import('./quality/types').QualityAssessment | null };

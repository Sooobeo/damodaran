"""Prepare inventory-v2 local QA observations; append only with --append.
...
from input_execution_v1 import local_question_evaluation_inventory_v2 as reval
from input_execution_v1 import recovery_relations_v2 as relations

VERSION = "input-execution-v1-local-question-ledger-evidence-inventory-v2"
ledger = original.ledger
CODE_PATH = "scripts/model-comparison/input_execution_v1/local_question_append_evidence_inventory_v2.py"
...
def prepare(*, folder, cohort, source_reviews, grades, report_path, relation_folder, destination, append=False, root=ROOT):
    ...
    result = {"version": VERSION, "status": "prepared", "createdAtUtc": datetime.now(timezone.utc).isoformat(),
        ...
        "recovery": validated["recovery"], "inventoryCorrection": validated["inventoryCorrection"], "humanReviewed": False, "modelCalls": 0, "translationReviewEventsAdded": 0,

"""Explicit inventory-v2 runner collection over byte-unchanged v1 exports.
...
VERSION = "input-execution-v1-local-question-transport-inventory-v2"
RUNNER_VERSION = "input-execution-v1-local-question-runner-inventory-v2"
...
def contents(formal, export, run, root):
    ...
    refs = [*formal["evidence"], *export_refs, *result["evidence"], *correction_refs(identity)]

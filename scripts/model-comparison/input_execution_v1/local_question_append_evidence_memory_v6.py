"""Prepare memory-v6 local QA observations; append only with --append.
...
from input_execution_v1 import local_question_evaluation_memory_v6 as reval
from input_execution_v1 import recovery_relations_v2 as relations

VERSION = "input-execution-v1-local-question-ledger-evidence-memory-v6"
ledger = original.ledger
CODE_PATH = "scripts/model-comparison/input_execution_v1/local_question_append_evidence_memory_v6.py"
...
def build_events(validated):
    ...
    for event in ev.ledger_observations(bundle, report, validated["evidenceRefs"]):
        ...
        event["questionContextProducerVersion"] = question_contexts[event["reviewId"]]["contextProducerVersion"]
    ...
    for row in observations:
        ...
        metadata["questionContextProducerVersion"] = question_contexts[mapped["reviewId"]]["contextProducerVersion"]

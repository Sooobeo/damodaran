"""Synthetic v5 provenance/ledger checks; S4 38+26 and QA 9+55 stay distinct."""
...
from input_execution_v1 import local_question_append_evidence_partial_recovery_v5 as app
from input_execution_v1 import local_question_evaluation_partial_recovery_v5 as local
from input_execution_v1 import local_question_transport_partial_recovery_v5 as transport
from input_execution_v1 import test_local_question_append_evidence_battery_v4 as support
from input_execution_v1.test_local_question_transport_partial_recovery_v5 import synthetic_partial, logical_summary, source_run


def fixture():
    data, formal, source, answers, grades, sr, gr, ar, cohort = support.fixture()
    partial, runs = synthetic_partial(formal["batteryExecution"])
    bindings = [{"reviewId": rid, "contextId": "synthetic-partial-" + rid, "contextProducerVersion": transport.CONTEXT_VERSION,
...
class PartialAppendTests(unittest.TestCase):
    ...
    def test_128_events_keep_s4_38_26_separate_from_question_9_55(self):
        ...
        for row in events:
            ...
            self.assertEqual(row["questionContextProducerVersion"], transport.CONTEXT_VERSION)

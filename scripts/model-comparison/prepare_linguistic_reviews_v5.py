...
from summarize_linguistic_reviews_v5 import check_producer_input, review_code_inventory, Inputs
...
def main():
    ...
    for directory in args.results:
        ...
        v5_review_evidence.check_artifacts(directory, summary, rows, evidence)
    ...
    write_once(output / "manifest.json", {**identity, "createdAtUtc": datetime.now(timezone.utc).isoformat(),
                                          ...
                                          "reviewEvidenceVersion": "v5",
                                          "v5ArtifactFilesSha256": v5_review_evidence.artifact_inventory_sha(evidence)})

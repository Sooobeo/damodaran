...
import summarize_linguistic_reviews_v4 as scorer
...
class ReviewSummaryTests(unittest.TestCase):
    def setUp(self):
        ...
        self.manifest = {"inputPath": str(self.source_path), "inputSha256": self.sha(self.source_path),
            ...
            "reviewEvidenceVersion": "v4", "reviewCodeFiles": scorer.review_code_inventory(),
            "v4ArtifactFilesSha256": scorer.v4_review_evidence.artifact_inventory_sha(scorer.Inputs(self.root))}
        self.predictions = []
    ...
    def test_preparer_checks_producer_contract_before_creating_packets(self):
        import prepare_linguistic_reviews_v4 as preparer

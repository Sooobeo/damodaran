"""TranslateGemma 27B v4: bounded-working-set paging experiment, not a safety guarantee."""
...
def run(args):
    ...
    summary = {"version": "translategemma-large-screen-v4", "status": "running", "startedAt": datetime.now(timezone.utc).isoformat(),
